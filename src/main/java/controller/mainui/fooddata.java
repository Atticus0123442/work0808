...
public class fooddata extends JFrame {
    ...
    public fooddata(users user) {
        ...
        backbtn.addMouseListener(new MouseAdapter() {
			...
			mainui frame = new mainui(newuser);
			frame.setVisible(true);
			self.dispose();
        	}
        });
        backbtn.setFont(new Font("新細明體", Font.PLAIN, 15));
        backbtn.setBounds(791, 29, 69, 41);
        contentPane.add(backbtn);

        JButton addbtn = new JButton("新增");
        addbtn.setFont(new Font("新細明體", Font.PLAIN, 15));
        addbtn.setBounds(525, 29, 81, 41);
        ...
        muchin.setFont(new Font("新細明體", Font.PLAIN, 15));
        ...
        scrollPane.setBounds(22, 95, 829, 404);
        ...
        chartbtn.setFont(new Font("新細明體", Font.PLAIN, 15));
        chartbtn.setBounds(616, 29, 81, 41);
        ...
        optbtn.setFont(new Font("新細明體", Font.PLAIN, 15));
        optbtn.setBounds(707, 29, 74, 41);
