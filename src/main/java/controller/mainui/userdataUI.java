...
public class userdataUI extends JFrame {
		...
		EventQueue.invokeLater(new Runnable() {
			public void run() {
				try {
					...
					userdataUI frame = new userdataUI(user,frame0);
	...
	public userdataUI(users user,mainui mainui) {
		userdataUI self = this;
		...
		weightin.setText(String.valueOf(user.getWeight()));
		...
		yearsin.setText(String.valueOf(user.getAge()));
		...
		heightin.setText(String.valueOf(user.getHeight()));
		...
		accountin.setText(user.getUsername());
...
//		timing_out.setText(formatted);
		...
		passwordin.setText(user.getPassword());
